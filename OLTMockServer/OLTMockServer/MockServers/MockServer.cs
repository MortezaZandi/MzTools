...
namespace OLTMockServer.MockServers
{
    public abstract class MockServer
    {
        ...
        protected MockServer(IOrderRepository orderRepository, OrderFactory orderFactory)
        {
        ...
        public Order CreateNewOrder(TestProject testProject, bool isAutoGenerated)
        {
            var newOrder = orderFactory.CreateNewOrder(testProject, isAutoGenerated);
